...
\noindent {\color{green} \textbf{Stochastic Process.}
...
\noindent {\color{green} \textbf{Markov Chain.}
...
\noindent{\color{green} \textbf{Bayes.} Let $A_1, A_2, \ldots, A_k$ be events such that $P(A_i) > 0$, $i = 1, 2, \ldots, k$. 
...
\noindent{\color{green} \textbf{Law of Total Probability.}
...
\noindent{\color{green} \textbf{(Stochastic Matrix).}
